...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="present_in_both_shapes" symbollevels="0" type="categorizedSymbol">
    <categories>
    ...
    <symbols>
      ...
      <symbol alpha="0.2" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="present_in_both_shapes"/>
